        ...
        <div className="mt-7 flex flex-col items-center justify-center gap-7 sm:flex-row sm:gap-10">
          {videos.map((video) => (
            <div key={video.label} className="flex w-full max-w-[330px] flex-col items-center">
              <div
                className={`w-full overflow-hidden rounded-[11px] bg-[#0E2A5E]/50 ring-1 ring-white/10 transition-[height] duration-300 ${playingVideo === video.label ? "h-[620px]" : "h-[380px]"}`}
              >
                <iframe
